 ...
 */
 $loggedcls = $user->uid > 0 ? " logged-in" : " not-logged-in";
?>
<span class="<?php print $flag_wrapper_classes . $loggedcls ;?>">
  <?php if($user->uid == 0): ?>
    <span title="<?php print $link_title; ?>" class="<?php print $flag_classes . $loggedcls ?>"><?php print $link_text; ?></span>
  <?php else: ?>
  <?php if ($link_href): ?>
    <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes . $loggedcls?>" rel="nofollow"><?php print $link_text; ?></a><span class="flag-throbber">&nbsp;</span>
  <?php else: ?>
